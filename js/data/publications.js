  ...
  timeline: {
    2025: [
      ...
      content: [
        ...
        "[strong]1. Passwords[/strong] — strong setup requirements and secure reset flows.",
        "[strong]2. Multi-Factor Authentication (2FA)[/strong] — combining knowledge, possession, and inherence factors.",
        "[strong]3. 3D Secure (3DS)[/strong] — additional authentication for card payments under PSD2 and SCA requirements.",
        "[strong]4. Biometric authentication[/strong] — fingerprints or facial recognition for secure and effortless access.",
      ...
      content: [
        ...
        "[quote]“Gestalt principles describe how humans group similar elements, recognize patterns, and simplify complex visuals when perceiving objects. Designers use these principles to organize content so interfaces are aesthetically pleasing and easy to understand.”[/quote][author] — Interactive Design Foundation[/author]",
        ...
        "[quote]“Hick’s Law states that the more choices users are presented with, the longer it takes them to make a decision. Designers use this principle to evaluate how many options should be offered at any given moment.”[/quote][author] — Interactive Design Foundation[/author]",
      ...
      content: [
        ...
        "[strong]1. Initial oversights[/strong] — small omissions seem harmless but accumulate quickly.",
        "[strong]2. Compounding issues[/strong] — each inaccessible feature adds complexity and cost.",
        "[strong]3. Integration challenges[/strong] — fixing issues later often requires redesigning existing systems.",
  ...
  2024: [
      {
        ...
        content: [
          ...
          "[strong]1. Conduct an IA audit[/strong] — catalogue all features, data, and user flows; identify pain points; document the current state.",
          "[strong]2. Define clear IA goals[/strong] — prioritise user-centric design, consistency, and scalability.",
          "[strong]3. Create a unified IA plan[/strong] — develop content models, sitemaps, and intuitive navigation paths.",
          "[strong]4. Implement structured data management[/strong] — centralise data, apply metadata and taxonomy, and establish data governance.",
          "[strong]5. Establish governance and maintenance[/strong] — assign ownership, perform regular audits, and maintain documentation.",
          "[strong]6. Enable cross-functional collaboration[/strong] — host workshops, align shared goals, and maintain continuous communication.",
      ...
      },
      {
        ...
        content: [
          ...
          "[strong]Initiation[/strong] — designers begin by understanding business requirements and analysing data.",
          "[strong]Data analysis[/strong] — collaboration with researchers to understand markets, competitors, user pain points, and opportunities.",
          "[strong]Prioritization and validation[/strong] — designers prioritise elements that meet business and user needs, sometimes redefining the core problem.",
          "[strong]Logical flow and user journey[/strong] — creation of flowcharts, journey maps, or similar tools to streamline experiences.",
          "[strong]Low-fidelity wireframing[/strong] — iterative sketching and early validation with stakeholders.",
          "[strong]High-fidelity mockups[/strong] — consistent designs built using a documented design system, leading to prototype creation.",
          "[strong]Prototyping and testing[/strong] — interactive prototypes support validation, testing, and clearer documentation.",
          "[strong]Documentation and handover[/strong] — final documentation and close collaboration with developers for smooth implementation.",
    ...
    2023: [
      {
        ...
        content: [
          ...
          "[strong]Disjointed user experience[/strong] — inconsistent design elements, varying interaction patterns, and fragmented workflows make applications difficult to navigate.",
          "[strong]Maintenance nightmares[/strong] — the absence of a coherent structure leads to spaghetti code, tangled dependencies, and poor modularisation, increasing the risk of bugs.",
          "[strong]Inefficient collaboration[/strong] — lack of standardised practices and documentation hampers teamwork, onboarding, and productivity.",
          "[strong]Unclear user journey[/strong] — without clear information architecture, users struggle to find features, leading to frustration and reduced satisfaction.",
          ...
          "[strong]User research and analysis[/strong] — conduct research to understand behaviours, pain points, and expectations through feedback, surveys, and usability testing.",
          "[strong]Content audit and prioritisation[/strong] — identify redundancies, outdated features, and prioritise elements aligned with user needs and business goals.",
          "[strong]Card sorting and wireframing[/strong] — use card sorting to understand mental models and wireframes to visualise the new structure.",
          "[strong]Iterative prototyping[/strong] — build interactive prototypes, gather feedback, and refine the architecture incrementally.",
          "[strong]Responsive design considerations[/strong] — ensure the architecture adapts seamlessly across devices, prioritising mobile usability.",
